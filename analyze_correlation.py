...
for i in range(segment.shape[0]):
    ...
    if movement_percent > purge_percent_threshold:
        print('{:s} {:.3f} {:.3f} {:.3f} {:.3f} {:10.3f} {:6.2f}%'.format(str(datetime.fromtimestamp(ts)), open, close, high, low, volume, movement_percent))

print('TIMESTAMP           OPEN   CLOSE  HIGH   LOW    VOLUME      MOVE')
