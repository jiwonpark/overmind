...
def history_condition(chart, i):
    ...
    # match = match and diff_diff_1m[0][dates[i-1]] > 0
    # match = match and diff_diff_1m[1][dates[i-1]] > 0
    ...
    match = match and (i - max(minimas[minimas < i]) < 10  if len(minimas[minimas < i]) > 0 else False)
